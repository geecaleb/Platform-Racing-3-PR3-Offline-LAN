...
public class PlayerUserData : BaseUserData
{
	...
	public PlayerUserData(DbDataReader reader) : this()
	{
		...
		this.BonusExpMultiplier = ((double)reader["bonus_exp_multiplier"], reader["bonus_exp_multiplier_end_time"] == DBNull.Value ? DateTime.MinValue : (DateTime)reader["bonus_exp_multiplier_end_time"]);
	}
